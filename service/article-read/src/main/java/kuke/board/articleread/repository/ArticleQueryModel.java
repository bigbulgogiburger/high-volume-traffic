...
public class ArticleQueryModel {
    ...
    public static ArticleQueryModel create(ArticleClient.ArticleResponse articleResponse, Long commentCount, Long likeCount){
        ...
        articleQueryModel.modifiedAt = articleResponse.getModifiedAt();
