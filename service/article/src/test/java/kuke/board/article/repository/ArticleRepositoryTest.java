...
class ArticleRepositoryTest {
    ...
    @Test
    void findAllTest(){
        List<Article> articles = articleRepository.findAll(1L, 1449970L, 30L);
    ...
    void findInfiniteScrollTest(){
        ...
        List<Article> allInfiniteScroll = articleRepository.findAllInfiniteScroll(1L, 30L, lastArticleId);
