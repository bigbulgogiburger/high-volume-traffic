...
public class ArticleLikeController {
    ...
    public void likeOptimisticLock2(@PathVariable("articleId") Long articleId, @PathVariable("userId") Long userId) {
    ...
    public void unlikeOptimisticLock2(@PathVariable("articleId") Long articleId, @PathVariable("userId") Long userId) {
