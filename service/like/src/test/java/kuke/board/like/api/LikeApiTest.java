...
public class LikeApiTest {
    ...
    void likePerformanceTest() throws InterruptedException {
        ...
        likePerformanceTest(executorService, 3333L, "pessimistic-lock-1");
        likePerformanceTest(executorService, 7777L, "pessimistic-lock-2");
    ...
    void likePerformanceTest(ExecutorService executorService,Long articleId, String lockType) throws InterruptedException {
        ...
        System.out.println(lockType+" time = " + (end-start));

        Long body = restClient.get().uri("/v1/article-likes/articles/{articleId}/count",articleId).retrieve()
                .body(Long.class);
