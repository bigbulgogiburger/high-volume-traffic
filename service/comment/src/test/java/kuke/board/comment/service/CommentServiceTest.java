...
class CommentServiceTest {
    ...
    void deleteSouldMarkDeletedIfHasChildren(){
        //given
        Long articleId = 1L;
        Long commentId = 2L;
    ...
    @Test
    @DisplayName("하위댓글이 삭제되고 삭제되지 않은 부모면, 하위 댓글만 삭제한다.")
    void deleteShouldDeleteChildOnlyIfNoteDeltedParent(){
        //given
        Long articleId = 1L;
        Long commentId = 2L;
    ...
    @Test
    @DisplayName("하위댓글이 삭제되고 삭제된 부모면, 재귀적 삭제")
    void deleteShouldDeleteChildAndParentRecursivelyIfDeletedParent(){
        //given
        Long articleId = 1L;
        Long commentId = 2L;
        Long parentCommentId = 1L;
